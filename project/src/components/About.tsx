...
export function About({ profile }: AboutProps) {
  return (
    <section id="about" className="relative py-20 bg-gradient-to-br from-indigo-950 to-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative group">
            ...
            <div className="relative p-8 bg-gradient-to-br from-indigo-950/50 to-purple-950/50 backdrop-blur-sm rounded-lg border border-indigo-500/20 hover:border-indigo-500/40 transition-all duration-300">
              <p className="text-gray-300 leading-relaxed text-lg transform transition-all duration-300 group-hover:translate-x-1">
                {profile.bio}
              </p>
